...
* **devcoredump**: submits device driver dumps exported by the kernel's
  devcoredump subsystem.
* **earlyoom**: submits information on processes terminated because the system
  ran out of memory.
...
* **sysreport**: submits system reports manually generated by the user.
* **trace**: submits trace logs generated by the ftrace subsystem, such as
  games that trigger [split locks](https://github.com/ValveSoftware/steam-for-linux/issues/8003)
