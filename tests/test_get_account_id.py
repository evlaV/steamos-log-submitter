...
from steamos_log_submitter.steam import get_account_id
    ...
    vdf = """"users"
{
    ...
    open_shim(vdf)
    assert get_account_id() == 1
    assert get_account_id(force_vdf=True) == 2
